...
<script>
import { listItemreceptdetail, getItemreceptdetail, delItemreceptdetail, addItemreceptdetail, updateItemreceptdetail } from "@/api/mes/wm/itemreceptdetail";
import { listItemrecptline, listWithDetail, getItemrecptline } from "@/api/mes/wm/itemrecptline";
...
export default {
  ...
  methods: {
    ...
    async handleHiPrint(row) {
      ...
      await getByTemplateType("ITEM_BATCH").then(res => {
