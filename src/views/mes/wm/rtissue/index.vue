  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="90px">
      ...
      <el-form-item label="退料类型" prop="rtType">
        <el-select v-model="queryParams.rtType" placeholder="请选择退料类型">
                <el-option
    ...
    <el-table v-loading="loading" :data="rtissueList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="退料单编号" width="150px" align="center" prop="rtCode" >
      ...
      <el-table-column label="退料类型" width="150px" align="center" prop="rtType" >
        <template slot-scope="scope">
