  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="960px" append-to-body>
      ...
      <el-card v-for=" (item,index) in processOptions " :key="index" v-if="activeProcess == index && form.workorderId !=null">
        <ProTask ref="proTask" :key="item.processId" :workorderId="form.workorderId" :routeId="item.routeId" :processId="item.processId" :colorCode="item.colorCode" :optType="optType"></ProTask>
      </el-card>
