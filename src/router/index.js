...
export const dynamicRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'rqc',
        component: () => import('@/views/mes/qc/pendinginspect/rqc'),
        name: 'rqcadd',
        props: true,
        meta: {title: '退料检验', activeMenu: '/mes/qc/pendinginspect/rqc'}
      },
      {
        path: 'oqc',
        component: () => import('@/views/mes/qc/pendinginspect/oqc'),
        name: 'oqcadd',
        props: true,
  ...
  },
  {
    ...
    children: [
      {
        path: 'form',
        component: () => import('@/views/mes/wm/productsales/form.vue'),
        name: 'productsalseForm',
        meta: { title: '销售出库详情', activeMenu: '/mes/wm/productsales/form' }
      }
    ]
  },
]
